...
class AsciidoctorPresentationPlugin : Plugin<Project> {
    ...
    fun Project.configureAsciidoctorTask(
        downloadTask: TaskProvider<Task>,
...
//                backends("revealjs")
    ...
    fun Project.createDownloadTask(extension: PresentationExtension, templateDir: Provider<Directory>, revealJsDir: Provider<Directory>, project: Project) = tasks.register("downloadTooling") {
        ...
        doLast {
            ...
            VfsProxy.request(project).run {
                ...
                cp(
                    options,
                    "zip:https://github.com/asciidoctor/asciidoctor-reveal.js/archive/v${extension.asciidoctorBackendVersion.get()}.zip!asciidoctor-reveal.js-${extension.asciidoctorBackendVersion.get()}",
                    templates
                )
    ...
    fun Project.configureAsciidoctor(extension: PresentationExtension) {
        extensions.getByType(AsciidoctorJExtension::class.java).setVersion(extension.asciidoctorJVersion)
    }
